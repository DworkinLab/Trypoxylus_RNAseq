---
title: "RNA_seq_Combined_Transcriptome_nutrition"
output:
...
readcounts_dm <- read.csv("combine_index_reads_rounded.csv", row.names = 1)
```
...
Compute the contrasts of interest and get the numbers of DE genes from each contrast, Combined Transcriptome
...
## Male MA Plots, Combined Transcriptome
...
```
## Female MA Plots, Combined Transcriptome
...
## Male Venn Diagram, Combined Transcriptome
...
## Female Venn Diagram, Combined Transcriptome
