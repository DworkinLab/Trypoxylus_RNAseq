---
title: "RNA_seq_Full_Transcriptome_nutrition"
output:
...
readcounts_dm <- read.csv("full_index_reads_rounded.csv", row.names = 1)
```
...
Compute the contrasts of interest and get the numbers of DE genes from each contrast, Full Transcriptome
...
## Male MA Plots, Full Transcriptome
...
```
## Female MA Plots, Full Transcriptome
...
## Male Venn Diagram, Full Transcriptome
...
## Female Venn Diagram, Full Transcriptome
